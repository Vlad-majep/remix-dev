...
module.exports = {
  ...
  before: function (browser: NightwatchBrowser, done: VoidFunction) {
    init(browser, done, 'http://127.0.0.1:3000/#optimize=true&runs=300&evmVersion=istanbul&version=soljson-v0.7.4+commit.3f05b770.js', true)
  },
  ...
  'Should load the code from URL params (code param) #group1': function (browser: NightwatchBrowser) {
    browser
      ...
      .url('http://127.0.0.1:3000/#autoCompile=true&optimize=true&runs=300&code=')
  ...
  'Should load the code from URL params (url param) #group1': function (browser: NightwatchBrowser) {
    browser
      ...
      .url('http://127.0.0.1:3000/#optimize=true&runs=300&url=https://github.com/ethereum/remix-project/blob/master/apps/remix-ide/contracts/app/solidity/mode.sol')
      .refreshPage() // we do one reload for making sure we already have the default workspace
  ...
  'Should load Etherscan verified contracts from URL "address" param) #group1': function (browser: NightwatchBrowser) {
    browser
      .url('http://127.0.0.1:3000/#address=0xdac17f958d2ee523a2206206994597c13d831ec7')
      .refreshPage()
      .pause(7000)
      .currentWorkspaceIs('code-sample')
  ...
  'Should load Blockscout verified contracts from URL "address" and "blockscout" params (single source)': function (browser: NightwatchBrowser) {
    browser
      .url('http://127.0.0.1:3000/#address=0xdAC17F958D2ee523a2206206994597C13D831ec7&blockscout=eth.blockscout.com')
      .refreshPage()
      .pause(7000)
      .currentWorkspaceIs('code-sample')
  ...
  'Should load Blockscout verified contracts from URL "address" and "blockscout" params (multiple sources)': function (browser: NightwatchBrowser) {
    browser
      .url('http://127.0.0.1:3000/#address=0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9&blockscout=eth.blockscout.com')
      .refreshPage()
      .pause(7000)
      .currentWorkspaceIs('code-sample')
      .assert.elementPresent('*[data-id="treeViewLitreeViewItemeth.blockscout.com"]')
  ...
  'Should load the code from URL & code params #group1': function (browser: NightwatchBrowser) {
    browser
      ...
      .url('http://127.0.0.1:3000') // refresh without loading the code sample
  ...
  'Should load the code from language & code params #group1': function (browser: NightwatchBrowser) {
    browser
      ...
      .url('http://127.0.0.1:3000/#language=yul&code=&optimize=false&runs=200&evmVersion=null')
      .refreshPage()
      .waitForElementVisible('[data-id="compilerContainerCompileBtn"]')
  ...
  'Should select deploy with proxy option from URL params #group2': function (browser: NightwatchBrowser) {
    browser
      .url('http://127.0.0.1:3000/#optimize=false&runs=200&deployProxy=true')
      .refreshPage()
  ...
  'Should select upgrade with proxy option from URL params #group2': function (browser: NightwatchBrowser) {
    browser
      .url('http://127.0.0.1:3000/#optimize=false&runs=200&upgradeProxy=true')
      .refreshPage()
  ...
  'Should load using various URL compiler params #group2': function (browser: NightwatchBrowser) {
    browser
      ...
      .url('http://127.0.0.1:3000/#optimize=true&runs=300&autoCompile=true&evmVersion=istanbul&version=soljson-v0.8.16+commit.07a7930e.js&language=Yul')
      .refreshPage()
      ...
      .url('http://127.0.0.1:3000/#version=0.8.7')
      .refreshPage()
      ...
      .url('http://127.0.0.1:3000/#version=0.8.15+commit.e14f2714')
      .refreshPage()
      .pause(3000)
      .clickLaunchIcon('solidity')
      .waitForElementVisible({
  ...
  'Should load using compiler from link passed in remix URL #group3': function (browser: NightwatchBrowser) {
    browser
      .url('http://127.0.0.1:3000/#version=https://solidity-blog.s3.eu-central-1.amazonaws.com/data/08preview/soljson.js&optimize=false')
      .refreshPage()
  ...
  'Should load json files from link passed in remix URL #group3': function (browser: NightwatchBrowser) {
    browser
      .url('http://127.0.0.1:3000/#optimize=false&runs=200&url=https://raw.githubusercontent.com/EthVM/evm-source-verification/main/contracts/1/0x011e5846975c6463a8c6337eecf3cbf64e328884/input.json')
      .refreshPage()
      .currentWorkspaceIs('code-sample')
  ...
  'Should execute function call from URL parameters #group3': function (browser: NightwatchBrowser) {
    browser
      .switchWorkspace('default_workspace')
      .url('http://127.0.0.1:3000?calls=fileManager//open//contracts/3_Ballot.sol///terminal//log//log')
      .refreshPage()
